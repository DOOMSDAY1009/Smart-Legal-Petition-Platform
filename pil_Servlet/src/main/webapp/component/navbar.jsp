			...
			<ul class="navbar-nav ms-auto mb-2 mb-lg-0">
				...
				<c:if test="${empty userObj }">
					...
					<li class="nav-item"><a class="nav-link active a2"
						aria-current="page" href="lawyer_login.jsp">LAWYER</a></li>
					<li class="nav-item"><a class="nav-link active a2"
						aria-current="page" href="user_record.jsp">RECORD</a></li>
					<li class="nav-item"><a class="nav-link active a2"
				...
				<c:if test="${not empty userObj }">
					...
					<li class="nav-item"><a class="nav-link active"
						aria-current="page" href="view_record.jsp">VIEW
							RECORD</a></li>
					...
					<!-- 	 <li><a class="dropdown-item" href="UploadServlet">Upload
									Images</a></li> -->
