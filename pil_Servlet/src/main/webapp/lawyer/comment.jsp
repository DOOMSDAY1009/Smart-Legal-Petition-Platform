		...
		<div class="row">
			...
			<div class="col-md-6 offset-md-3">
				<div class="card paint-card">
					<div class="card-body">
						<p class="text-center fs-4">User Comment</p>

						<%
						int id = Integer.parseInt(request.getParameter("id"));
						RecordDao dao = new RecordDao();

						Record ap = dao.getRecordById(id);
						%>
						<form class="row" action="../updateStatus" method="post">
							...
							<div class="col-md-6">
								<br> <label>title</label> <input type="text" readonly
									value="<%=ap.gettitle()%>" class="form-control">
							</div>
							...
							<input type="hidden" name="id" value="<%=ap.getId()%>"> <input
								type="hidden" name="did" value="<%=ap.getLawyerId()%>">
